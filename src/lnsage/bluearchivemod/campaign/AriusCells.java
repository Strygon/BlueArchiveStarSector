...
public class AriusCells extends BaseMarketConditionPlugin {

	public static int STABLITY_PENALTY = 1;
	
	protected AriusCellsIntel intel;
	...
	public void setParam(Object param) {
		intel = (AriusCellsIntel) param;
	}
	
	public AriusCellsIntel getIntel() {
	...
	public void apply(String id) {
		if (!intel.isSleeper()) {
			...
			String name = "Active Arius cells";
			if (stability != 0) {
