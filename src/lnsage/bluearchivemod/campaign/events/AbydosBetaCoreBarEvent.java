...
public class AbydosBetaCoreBarEvent extends BaseBarEventWithPerson {
    ...
    public boolean shouldShowAtMarket(MarketAPI market) {
        ...
        if (Global.getSector().getIntelManager().hasIntelOfClass(AbydosBetaCoreIntel.class)) {
            return false;
        }
